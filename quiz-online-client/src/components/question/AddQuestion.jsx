...
const AddQuestion = () => {
	...
	const [username, setUsername] = useState(""); // Ajout du state pour stocker le nom d'utilisateur
	...
	const handleAddChoice = () => {
		//Elle obtient la lettre du dernier choix ajouté, détermine la lettre suivante dans l'alphabet et crée un nouveau choix avec cette lettre suivie d'un point.
